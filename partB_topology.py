...
class CSLRTopo( Topo ):
        ...
        def __init__( self ):
                ...
                self.addLink( R1, R2, bw=100 ) # R1 eth2 <---> R2 eth2
                self.addLink( R1, R3, bw=100 ) # R1 eth3 <---> R3 eth2
                self.addLink( R2, R3, bw=100 ) # R2 eth3 <---> R3 eth3
...
def run():
        ...
        Alice = net.get( 'Alice' )
        Alice.intf( 'Alice-eth0' ).setIP( '10.1.1.17', 24 ) # subnet mask??
